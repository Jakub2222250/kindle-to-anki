...
class ChatCompletionUsageLevel:
    ...
    def estimate(self, usage_inputs: List[UsageLevelInput], runtime_config: RuntimeConfig, ignore_cache: bool = False, use_test_cache: bool = False) -> List[UsageLevelOutput]:
        ...
        MAX_RETRIES = 1
        retries = 0
        failing_inputs = self._process_batches(inputs_needing_estimation, cache, source_language_name, runtime_config)
    ...
    def _make_batch_call(self, batch_inputs: List[UsageLevelInput], processing_timestamp: str, source_language_name: str, runtime_config: RuntimeConfig) -> Tuple[Dict[str, Any], str, str]:
        items_list = []
