...
2. original_language_definition: Polish definition of the lemma form (not the inflected input word), with the meaning determined by how the input word is used in the input sentence. Consider the part of speech when providing a concise dictionary-style gloss for the base form.
...
if __name__ == "__main__":
    ...
    for i, test_case in enumerate(test_cases):
        ...
        print(f"  Collocations:           {note.collocations} (not provided by LLM enrichment)")
